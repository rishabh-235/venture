...
import { ReactComponent as MySVG } from "../../components/images/bg-svg.svg";
    ...
    <>
      <div className="flex flex-col justify-center items-center">
        <div className="w-[75%] h-[4.5rem] flex justify-center items-center mt-8 border rounded-md px-4">
          ...
          <span className="material-symbols-outlined text-[1.8rem] text-gray-500 p-2">
        ...
        <div className=" gap-4 flex flex-col justify-center items-center -mt-[20rem]">
          <h1 className=" text-[1.4rem] text-gray-700 font-[600]">
            Complete your pitch
          </h1>
          <p className=" text-[0.9rem] font-[500] w-[37rem] tracking-wide">
          ...
          <Link
            ...
            className="gap-1 mb-[10rem] rounded-lg text-white text-[0.9rem] font-[800] flex justify-center items-center bg-[#16263d] py-[0.55rem] px-6"
          >
            Complete Pitch
          </Link>
        </div>
