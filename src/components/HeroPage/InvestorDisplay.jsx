              ...
              <Card className=" w-[30vw] h-[24.6vw] border">
                <CardBody className="flex flex-col ">
                  ...
                  <div className="flex mt-5 flex-col justify-center items-center">
                    ...
                    <div className="w-[25vw] h-[5vw] flex justify-start items-center mt-6 transition ease-in-out delay-150  hover:-translate-y-1.5 hover:translate-x-1.5 hover:scale-110  duration-300 ... border rounded-lg">
