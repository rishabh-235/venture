...
import NewToInvesting from "./NewToInvesting";
...
const LandingPage = () => {
  ...
  const cardData = useMemo(
    () => [
      ...
      { src: img4, invested: "4999989", investor: "1440", coinvested: logo4 },
      { src: img5, invested: "4914037", investor: "24543", coinvested: logo4 },
      { src: img6, invested: "5240140", investor: "1220", coinvested: logo5 },
        ...
        <div className="xl:hidden">
          <div className="flex flex-col w-auto mb-9">
            ...
            <p className=" text-gray-900 text-lg mt-5 px-16 tracking-wide">
              ...
              businesses you love-for as little as ₹10000.
            </p>
            ...
            <div>
              <Link
                ...
                className=" mt-5 align-middle select-none text-center transition-all  disabled:pointer-events-none font-semibold text-base tracking-wider py-3.5 px-36 rounded-lg bg-light-blue-700 text-white hover:shadow-lg hover:bg-light-blue-900 border-y border-x border-light-blue-700"
              >
                Join VentureList
              </Link>
            </div>
            ...
            <div>
              <button
                type="button"
                data-ripple-light="true"
                className=" mt-3 align-middle select-none text-center transition-all  disabled:pointer-events-none font-semibold text-base tracking-wider py-3.5 px-36 rounded-lg bg-opacity-15 text-black hover:shadow-lg hover:bg-white border-y border-x border-gray-500"
              >
                Explore Startups
              </button>
            </div>
            ...
            <div className="flex mt-[2.5vw]">
              <div className=" mr-2">
                <Link
                  ...
                  type="button"
                  data-ripple-light="true"
                  className=" mt-5 align-middle select-none text-center transition-all  disabled:pointer-events-none font-semibold text-base tracking-wider py-3.5 px-14 rounded-lg bg-light-blue-700 text-white hover:shadow-lg hover:bg-light-blue-900 border-y border-x border-light-blue-700"
                >
                  Join VentureList
                </Link>
              </div>
              ...
              <div className=" ml-2">
                <button
                  type="button"
                  data-ripple-light="true"
                  className=" mt-5 align-middle select-none text-center transition-all  disabled:pointer-events-none font-semibold text-base tracking-wider py-3.5 px-14 rounded-lg bg-opacity-15 text-black hover:shadow-lg hover:bg-white border-y border-x border-gray-500"
                >
                  Explore Startups
                </button>
              </div>
