    ...
    <>
      <div className=" flex w-[78rem] h-[9rem]">
        <Link className=" h-[6rem]" to="founder">
          <div className="h-[5rem] flex justify-center items-center w-[17rem] rounded-md bg-gradient-to-br from-blue-700 via-purple-700 to-purple-700 mt-5 mb-14 mr-5 p-[0.1rem]">
            <div className="flex flex-col h-full w-[16.8rem] items-center justify-center bg-white rounded-md">
        ...
        <Link className=" h-[6rem]" to="topinvestor">
          <div className="h-[5rem] flex justify-center items-center w-[17rem] rounded-md bg-gradient-to-br from-blue-700 via-purple-700 to-purple-700 mt-5 mb-14 mr-5 p-[0.08rem]">
            <div className="flex flex-col h-full w-[16.8rem] items-center justify-center bg-white rounded-md">
