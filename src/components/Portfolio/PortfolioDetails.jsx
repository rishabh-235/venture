...
import CollapseDefault from "./CancleInvestment";
      ...
      <div className=" flex flex-col justify-center items-start mt-[3.7rem] w-[63rem] mb-[3.5rem]">
        ...
        <div className="flex justify-end items-center">
          <p className="flex justify-center items-center text-[3.2rem] ">
            <span className="text-[2.8rem] material-symbols-outlined font-[400]">
              currency_rupee
            </span>
            0
          </p>
        ...
        <div className="flex mt-[2rem] ml-2">
          <p className="flex justify-center items-center text-[1.7rem] font-[500]">
            <span className="material-symbols-outlined font-[400]">
              currency_rupee
            </span>
            0
        ...
        <div className="flex flex-col justify-center items-center w-[18rem]">
          ...
          <div className="mt-[2rem]">
            <a
              ...
              className=" align-middle select-none text-center text-[0.7rem] font-[600] tracking-widest transition-all  disabled:pointer-events-none py-3.5 px-5 rounded-[0.2rem] bg-light-blue-800 text-white hover:shadow-lg hover:bg-light-blue-900 border-y border-x border-light-blue-800"
            >
              EXPLORE COMPANIES
            </a>
          </div>
