      ...
      <div>
        ...
        <div className=" flex justify-between">
          <label className=" inline-flex items-center cursor-pointer">
            ...
            <div className="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-0 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-[#3b9ff3]"></div>
            <span className="ms-2 text-[0.95rem] font-medium text-gray-700 dark:text-gray-300">
              Founder
            </span>
          </label>
          ...
          <div className="w-auto flex flex-col justify-end">
            ...
            >
              Advanced{" "}
              {(openSection === "name" && (
                <span className="material-symbols-outlined font-[500]">
                  keyboard_arrow_up
                </span>
              )) || (openSection !== "name" && (<span className="material-symbols-outlined font-[500]">keyboard_arrow_down</span>))}
            </button>
          </div>
        </div>
