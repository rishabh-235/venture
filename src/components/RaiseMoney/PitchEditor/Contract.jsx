  ...
  return (
    <div className=" mb-20">
      ...
      <div className=" ml-[2.5rem] w-1/2">
        <div className=" flex items-center mb-[1.05rem]">
          <input
            id="default-radio-1"
            type="radio"
            value="future"
            ...
            className="w-4 h-4 text-gray-600 cursor-pointer  bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
          />
          <label
            for="default-radio-1"
            className=" flex ms-2 text-[0.93rem] font-medium text-gray-800 dark:text-gray-300"
          >
            <p className="flex items-center cursor-pointer">
              Future Equity (SAFE)
            </p>
            <p className=" peer flex cursor-pointer">
              <button type="button">
                <svg
                  className="w-4 h-4 ms-2 text-gray-400 hover:text-gray-700"
                  aria-hidden="true"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <div className=" peer-hover:opacity-100 peer-hover:-translate-x-[15rem] peer-hover:duration-0 absolute inline-block text-gray-900 placeholder:text-blue-gray-200 bg-white border-2 border-gray-200 rounded-[5px] opacity-0 w-[24rem] mt-7 ml-[20rem] p-[0.05rem]">
              <div className=" p-6 space-y-2 text-start bg-[#f1f9fe]">
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            <p className="peer flex items-center cursor-pointer">
              <button type="button">
                <svg
                  className="w-4 h-4 ms-2 text-gray-400 hover:text-gray-700"
                  aria-hidden="true"
            ...
            <div
              ...
              role="tooltip"
              className=" peer-hover:opacity-100 peer-hover:-translate-x-[15rem] peer-hover:duration-0 absolute inline-block text-gray-900 placeholder:text-blue-gray-200 bg-white border-2 border-gray-200 rounded-[5px] opacity-0 w-[24rem] mt-7 ml-[20rem] p-[0.05rem]"
            >
              <div className="p-6 space-y-2 text-start bg-[#f1f9fe]">
                <h3 className="text-[1rem]">
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            >
              <div className="p-6 space-y-2 text-start bg-[#f1f9fe]">
                <h3 className="text-[1rem]">Best for mainstreet companies</h3>
                <p className=" text-[0.75rem]">
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            <div
              ...
              id="popover-description-2"
              role="tooltip"
              className=" peer-hover:opacity-100 peer-hover:-translate-x-[10rem] peer-hover:duration-0 absolute inline-block text-gray-900 placeholder:text-blue-gray-200 bg-white border-2 border-gray-200 rounded-[5px] opacity-0 w-[24rem] mt-7 ml-[15rem] p-[0.05rem]"
            >
              <div className="p-6 space-y-2 text-start bg-[#f1f9fe]">
                <h3 className="text-[1rem]">Good deal for investors</h3>
                <p className=" text-[0.75rem]">
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            >
              <div className="p-6 space-y-2 text-start bg-[#f1f9fe]">
                <h3 className="text-[1rem]">Best for grandma</h3>
                <p className=" text-[0.75rem]">
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            >
              <div className="p-6 space-y-2 text-start bg-[#f1f9fe]">
                <h3 className="text-[1rem]">
                  Best for those with good lawyers
                </h3>
                <p className=" text-[0.75rem]">
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            >
              <div className="p-6 space-y-2 text-start bg-[#f1f9fe]">
                <h3 className="text-[1rem]">That's okay!</h3>
                <p className=" text-[0.75rem]">
              ...
              <div className=" mb-5 mt-5">
                ...
                <div className="w-[31.7rem] relative mt-3">
                  <select
                    ...
                    id="repayment"
                    name="repayment"
                    className="peer focus:placeholder:text-transparent focus:ring-black focus:border-none pl-[1.1rem] flex justify-center items-center text-[1.02rem] tracking-wider pt-2 font-[500] text-gray-900 placeholder:text-blue-gray-200 w-[31.7rem] h-[3.7rem] rounded-[0.4rem] border-gray-300 border-[1px] mb-3"
                  >
                    <option
        ...
        <div className=" flex flex-col ml-[2.5rem] w-1/2 text-start mt-10 py-1 gap-1">
          ...
          <div className=" flex items-center mb-[1.05rem]">
            <input
              ...
              name="terms_to_vip"
              onChange={handleChange}
              className=" w-4 h-4 text-gray-600 cursor-pointer  bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
            />
            <label
              for="terms_to_vip1"
              className=" flex ms-2 text-[0.93rem] font-medium text-gray-800"
            >
              <p className="flex items-center cursor-pointer">
