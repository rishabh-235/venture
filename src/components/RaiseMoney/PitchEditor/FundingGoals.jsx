              ...
              <div className=" ml-4">
                ...
                <p className=" flex">
                  ...
                  <p className="peer flex items-center cursor-pointer">
                    <button type="button">
                      <svg
                        className="w-5 h-5 ms-1 text-gray-500 hover:text-[#16263d]"
                        aria-hidden="true"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div
                    ...
                    role="tooltip"
                    className=" peer-hover:opacity-100 z-50 peer-hover:-translate-x-[10rem] peer-hover:duration-0 absolute inline-block placeholder:text-blue-gray-200 bg-[#16263d] rounded-[5px] opacity-0 w-[21rem] top-[0.2rem] ml-[11rem] shadow-md shadow-gray-800"
                  >
