        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            <div
              ...
              role="tooltip"
              className=" peer-hover:opacity-100 z-50 peer-hover:-translate-x-[10rem] peer-hover:duration-0 absolute inline-block placeholder:text-blue-gray-200 bg-[#16263d] rounded-[5px] opacity-0 w-[19rem] top-[5rem] ml-[21.5rem] shadow-md shadow-gray-800"
            >
        ...
        <div className=" flex items-center mb-[1.05rem]">
          ...
          >
            ...
            <div
              ...
              id="popover-description-2"
              role="tooltip"
              className=" peer-hover:opacity-100 z-50 peer-hover:-translate-x-[10rem] peer-hover:duration-0 absolute inline-block placeholder:text-blue-gray-200 bg-[#16263d] rounded-[5px] opacity-0 w-[19rem] top-[7.5rem] ml-[21.7rem] shadow-md shadow-gray-800"
            >
              <div className="p-4 space-y-2 text-start">
                <p className=" text-[0.75rem] text-white font-[600] leading-[1rem]">
