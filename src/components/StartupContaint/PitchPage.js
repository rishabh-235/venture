      ...
      <div className=" flex flex-col justify-center items-center w-[80rem]">
        ...
        <div className=" w-[78rem] h-auto mt-[1.7rem] flex flex-row justify-between items-start">
          <div className="flex flex-col justify-between items-start">
            <div className="w-[54.2rem] h-full">
              <div className="h-[30rem] relative">
                {!isPlaying && (
                  <div className="w-[54.2rem] h-[31rem] flex justify-center items-center absolute z-10">
                    ...
                    <div
                      className="flex justify-center items-center absolute w-full h-full visible z-20 cursor-pointer"
            ...
            <div className="flex justify-between items-center w-full mt-2 ml-1">
              <div className=" flex ">
                ...
                <div className=" flex justify-center items-center">
                  <Typography
                    as="a"
                    href="#"
                    className="opacity-80 transition-opacity hover:opacity-100 ml-2 text-gray-500"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
                  ...
                  <Typography
                    as="a"
                    href="#"
                    className="opacity-80 transition-opacity hover:opacity-100 ml-4 text-gray-500"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
              ...
              <div className="flex text-[0.6rem] text-gray-700 tracking-wider p-2">
                <p className=" rounded-[5px] mr-2 px-2 py-1">Technology</p>
                <p className=" rounded-[5px] mr-2 px-2 py-1">Retail</p>
                <p className=" rounded-[5px] mr-2 px-2 py-1">B2C</p>
                <p className=" rounded-[5px] mr-2 px-2 py-1">Transportation</p>
