...
export default function NavBar() {
  ...
  const [raiseMoneyLink, setRaiseMoneyLink] = useState("/register_startup");
  ...
  return (
    <nav className=" bg-white w-full flex relative justify-between items-center mx-auto px-8 h-16 z-10 border border-b-[0.099rem]">
      {/* <!-- logo --> */}
