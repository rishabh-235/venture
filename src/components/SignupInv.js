...
const SignupInv = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8000/api/v1/user/register", formData,{withCredentials: true })
      .then((response) => {
        if (response.data) {
          setFullname("");
          setEmail("");
  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center">
        ...
        <p className=" mt-3 text-[1.5rem] tracking-wide">
        ...
        <div className=" mb-16 mt-12 flex justify-around items-start h-[25rem] w-[70rem]">
          <div className=" flex flex-col items-start justify-start">
            ...
            >
              <svg
                className="-ml-[4rem] mr-[4rem] material-symbols-outlined"
            ...
            >
              <svg
                className="-ml-[3rem] mr-[4rem] material-symbols-outlined"
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
                width="25"
          ...
          <div>
            <form onSubmit={handleSubmit}>
              <p className=" text-red-600 text-[0.7rem] -mt-3 text-start">
                {emailerror}
              </p>
              <div className=" relative ">
                <input
                  id="email"
                  className={`peer placeholder-transparent flex justify-center items-center text-[1.05rem] tracking-wider pt-6 font-[500] w-[22.1rem] h-[3.7rem] rounded-xl border-${bordercolor} border-[1px] hover:border-gray-700 mb-3`}
                  type="text"
                  name="email"
                  value={email}
                  placeholder="Email"
              ...
              <div className=" relative ">
                <input
                  id="password"
                  className="peer placeholder-transparent flex justify-center items-center text-[1.2rem] tracking-wider pt-6 font-[900] w-[22.1rem] h-[3.7rem] rounded-xl border-gray-300 border-[1px] hover:border-gray-700 mb-3"
                  type="password"
                  name="password"
              ...
              <div>
                <button
                  ...
                  className=" mt-4 align-middle select-none text-center transition-all  disabled:pointer-events-none font-[600] text-[0.9rem] tracking-wider py-3 px-[9.2rem] rounded-md bg-light-blue-800 text-white hover:to-transparent hover:shadow-lg hover border-y border-x border-light-blue-700"
                >
                  SignUp
                </button>
              </div>
